        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los fundamentos del derecho laboral colombiano, las normativas han sido una herramienta esencial para garantizar la justicia y la equidad en las relaciones entre empleadores y empleados. La administración de salarios, en este contexto, surge como un proceso clave tanto en el sector público como privado, regulando condiciones laborales y promoviendo un marco estructurado para la compensación. En esta unidad, se profundizará en los principios legales que rigen las relaciones laborales y la gestión salarial, así como en las diferencias entre sectores, fomentando una comprensión integral que fortalezca las competencias profesionales.
              
              p #[b ¡Prepárese para enfrentar los desafíos de la administración laboral con criterio y confianza!]
